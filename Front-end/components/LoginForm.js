    ...
    <div className="flex flex-nowrap w-screen">
      <div className="flex flex-col justify-center items-center w-2/5 h-screen bg-gradient-to-b from-amber-300 to-blue-500">
        <div className="flex flex-col justify-center  bg-white/50 rounded-xl m-10 p-5 shadow-2xl">
          <h2 className="text-4xl mt-8 font-bold text-blue-600">
            INICIAR SESIÓN
          </h2>
          <form
          ...
          >
            <div>
              <label className="text-xl font-bold text-blue-600">Correo</label>
              <br />
              <input
                type="text"
                value={email}
            ...
            <button
              className="bg-blue-500 text-white px-5 py-3 my-3 rounded-md"
              type="submit"
            >
              Iniciar sesión
            </button>
          ...
          <button
            className="bg-violet-500 text-white px-5 py-2 my-3 rounded-md"
            onClick={toggleForm}
          >
            Registrarse Ahora
          </button>
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-5xl text-white font-bold">REGISTRO FIS</h1>
          <h2 className="text-3xl text-white font-bold">
            El sistema para control de docentes para la FIS
          </h2>
        </div>
      </div>
    </div>
